...
function lightStars(e) {
   ...
   for (var j = starNumber; j < 5; j++) {
      stars[j].setAttribute("src", "bw_star.png");
   }
   document.getElementById("rating").setAttribute("value", starNumber + " stars");
...
function updateCount(e) {
   ...
   wordCountBox.setAttribute("value", charCount + "/1000");
   if (charCount > 1000) {
